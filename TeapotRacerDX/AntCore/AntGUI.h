...
public:
	...
	void AddImageText(int id, LPCWSTR text, int x, int y, int h, int w);
	void AddButton(int id, LPCWSTR text, int x, int y, int h, int w);
	void AddComboBox(int id, int x, int y, int h, int w);
	void AddCheckBox(int id, LPCWSTR text, int x, int y, int h, int w);
	void AddTextBox(int id, LPCWSTR text, int x, int y, int h, int w);
	void AddTextArea(int id, LPCWSTR text, int x, int y, int h, int w);
	void AddListBox(int id, LPCWSTR text, int x, int y, int h, int w);
    ...
    bool Event(UINT Event, WPARAM wParam, LPARAM lParam);
	void Render(float time);

	void DrawText(UINT fontId, LPCWSTR string, AntFontColorARGB* fontColor, RECT* dst);
...
public:
	AntGUIComponent();
    virtual bool Event(UINT Event, WPARAM wParam, LPARAM lParam) { return false; }
...
public:
	...
	virtual void Render(float time);
	virtual bool Event(UINT Event, WPARAM wParam, LPARAM lParam);
...
public:
	...
	virtual void Render(float time);
	virtual bool Event(UINT uEvent, WPARAM wParam, LPARAM lParam);
...
public:
	...
	virtual void Render(float time);
	virtual bool Event(UINT Event, WPARAM wParam, LPARAM lParam);
	void AddOption(int id, LPCWSTR text, void** userData);
...
{
	void AddPane(int id, LPCWSTR text, AntGUIDialog *pane);
	void GetPane(int id);
